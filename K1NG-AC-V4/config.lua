...
Config.DiscordWebhook = "https://discord.com/api/webhooks/1297530923071438900/FbO0CMjGZ15s8ql_eLVsCGVlurZqYYJy4-CLLN2ACqzCBiDKxrEhuqioreDJoPRDomHD"
...
Config.Modules = {
    ...
    ChatProfanityModule = {
        ...
        badWords = {"Foo", "Bar", "Foobar", "Nigger"},
        -- The message to send to the player if he uses a bad word.
        warningMsg = "^1あなたが使ったら言葉はこのサーバーでブラックリストされています^0"
    },
    ...
    DeferralsModule = {
        ...
        NoVPN = {
            enabled = true,
            rejectionMsg = "このサーバーではVPNが禁止されています"
        },
        ...
        BanChecker = {
            enabled = false,
            rejectionMsg = "あなたはこのサーバーからバンされています"
        }
    },
